...
public class Log4jInit {
    ...
    private static final String DEFAULT_LOG_FILE_NAME = "Info.log";
    private static final String TAG = "Log4jUtils";
    // 对应AndroidManifest文件中的package
    private static final String PACKAGE_NAME = "com.example.activity";
